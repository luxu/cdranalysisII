...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', user.manager.MinUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('thing', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='things_profiles', to='cdr.thing')),
